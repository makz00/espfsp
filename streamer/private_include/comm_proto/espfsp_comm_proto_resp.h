...
typedef enum {
    ...
    ESPFSP_COMM_RESP_MAX_NUMBER = 0x04,

    // ESPFSP_COMM_RESP_CAM_PARAMS_RESP = 0x03,
    // ESPFSP_COMM_RESP_FRAME_PARAMS_RESP = 0x04,
    // ESPFSP_COMM_RESP_PROTO_PARAMS_RESP = 0x05,
    // ESPFSP_COMM_RESP_SOURCES_RESP = 0x06,
    // ESPFSP_COMM_RESP_ERROR_REPORT = 0x08,
    // ESPFSP_COMM_RESP_MAX_NUMBER = 0x09,
