...
// // For ESPFSP_COMM_REQ_CAM_SET_PARAMS
typedef struct {
    uint32_t session_id;
    uint16_t param_id;
    uint32_t value;
} espfsp_comm_req_cam_set_params_message_t;

// // For ESPFSP_COMM_REQ_CAM_GET_PARAMS
typedef struct {
    uint32_t session_id;
    uint16_t param_id;
} espfsp_comm_req_cam_get_params_message_t;

// // For ESPFSP_COMM_REQ_FRAME_SET_PARAMS
typedef struct {
    uint32_t session_id;
    uint16_t param_id;
    uint32_t value;
} espfsp_comm_req_frame_set_params_message_t;

// // For ESPFSP_COMM_REQ_FRAME_GET_PARAMS
typedef struct {
    uint32_t session_id;
    uint16_t param_id;
